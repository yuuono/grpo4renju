...
\end{align}$$であり，初期状態$(t=0)$から将来得られる報酬の合計
$$\begin{align}
...
このため，行動価値関数$Q_\pi(s, a)$の行動を方策$\pi$に従って選ぶとしたら，行動価値関数$Q_\pi(s, a)$と状態価値関数 $V_\pi(s)$は同じになる．そのため，状態価値関数$V_\pi$ は，その状態で取り得る行動価値関数 $Q_\pi(s,a)$を方策で平均したものという次の式が成り立つ．
$$
